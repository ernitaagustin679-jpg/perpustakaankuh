...
import { Mail, Lock, Library, Loader2, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-bg flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 font-sans">Continue your reading journey</p>
        </div>
        ...
        <div className="mt-10 text-center">
          <p className="text-gray-500 text-sm">
            ...
            <Link to="/register" className="text-primary font-bold hover:underline">Create a new account</Link>
          </p>
        </div>
      </motion.div>
    </div>
